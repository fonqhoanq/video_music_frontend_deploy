<template>
        ...
        <v-menu offset-y left>
          <template v-slot:activator="{ on }">
            <v-btn small color="red" depressed fab v-on="on" class="white--text">
              ...
              <template v-else>
                <span class="headline">
                  {{ getCurrentSinger.channelName.split('')[0].toUpperCase() }}
                </span>
              </template>
            </v-btn>
          </template>
          ...
          <v-card>
            ...
            <v-list>
              <v-list-item
                router
                :to="`/channels/${$store.getters.getCurrentSinger.id}`"
              >
                <v-list-item-icon>
            ...
            <v-list class="text-center">
              <v-list-item class="px-2">
                <v-btn
                  ...
                  depressed
                  fab
                  :to="`/channels/${getCurrentSinger.id}`"
                ...
                >
                  ...
                  <!-- </template> -->
                  <!-- <span class="display-3" v-if="getCurrentSinger.avatarUrl === 'no-photo.jpg'">
                    {{ getCurrentSinger.channelName.split('')[0].toUpperCase() }}
                  </span> -->
                </v-btn>
              </v-list-item>
  ...
  export default {
    ...
    components: {
      UploadVideoModal,SingerSettingsModal
    },
    mounted() {
