        ...
        <v-card-text>
          <v-row>
            ...
            >
              ...
              >
                <div
                  v-if="$store.getters.getCurrentSinger.avatarUrl == 'no-photo.jpg'"
                  class="px-12"
  ...
  export default {
    ...
    methods: {
      async submit() {
        ...
        const singer = await AuthenticationService.updateSingerDetails({
        ...
        if (
          this.formData.channelName !==
            this.$store.getters.getCurrentSinger.channelName ||
          this.formData.email !== this.$store.getters.getCurrentSinger.email
        ) {
      ...
      async submitPassword() {
        ...
        const singer = await AuthenticationService.updatePassword({
      ...
      cropSuccess(imgDataUrl, field) {
        ...
        console.log(typeof this.imgDataUrl)
        // console.log(field)
      },
      cropUploadSuccess(jsonData, field) {
        ...
        var avatar = ''
        console.log(jsonData.avatarUrl)
